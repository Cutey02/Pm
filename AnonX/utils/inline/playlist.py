...
def top_play_markup(_):
    buttons = [
        [
            InlineKeyboardButton(
                text="✦ᴛᴏᴘ 10 ʟɪsᴛ✦", callback_data="SERVERTOP"
            )
        ],
        [
            InlineKeyboardButton(
                text="✦ᴏᴡɴ✦", callback_data="SERVERTOP user"
            )
        ],
        [
            InlineKeyboardButton(
            ...
            InlineKeyboardButton(
                text="✦ɢʀᴏᴜᴘ✦", callback_data="SERVERTOP chat"
            )
        ],
        [
            InlineKeyboardButton(
...
def top_play_markup(_):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="✦ɢʀᴏᴜᴘ✦", callback_data="SERVERTOP Group"
            )
        ],
        [
            InlineKeyboardButton(
